...
void main() {
  const radius = 50;
  final scale = radius.toDouble();

  final poly1 = RoundedPolygon.fromNumVerts(3, centerX: 0.5, centerY: 0.5);
  final poly2 = RoundedPolygon.fromNumVerts(4, centerX: 0.5, centerY: 0.5);
  ...
  test("morphDrawingTest", () {
    // Shapes are in canonical size of 2x2 around center (.5, .5). Translate/scale to
    // get a larger path
    throw UnimplementedError("Morph drawing test is not implemented in Dart yet.");
  });
}
